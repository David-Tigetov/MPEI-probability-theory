...
Определим значение условного математического ожидания $\expectation{\condition{Z}{X}}$ при различных значениях $X$. Пусть $X = m$, тогда:
\begin{gather}
    Z = \sum_{k=1}^m Y_k, \\
    %
...
\end{multline}
Причем величины $X$ и $Y_1$ имеют одинаковое распределение и
\begin{multline}
    \expectation{X^2}
