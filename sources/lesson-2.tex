...
Числа 1, 2, \dots, 9 записываются в случайном порядке. Найти вероятности событий:
\begin{enumerate}
    \item $B = \event{\text{числа 1 и 2 будут стоять рядом и в порядке возрастания}}$,
    \item $C = \event{\text{числа 3, 6 и 9 будут стоять рядом}}$.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item третью позицию --- любая из оставшихся 7 цифр, и так далее, для последней позиции останется 1 цифра. Таким образом, всего вариантов записи цифр:
    \begin{equation}
    ...
    Вероятность события $B$
    \begin{equation}
        \probability{B} = \frac{\modulus{B}}{\modulus{\Omega}} = \frac{8 \cdot 7!}{9!} = \frac{1}{9} .
    \end{equation}
    ...
    \begin{equation}
        ...
        \end{array}
    \end{equation}
    Группа цифр $\left \{ 3, 6, 9 \right \}$ может занимать 7 различных местоположений, на каждое местоположение приходится $3!$ вариантов расположения цифр внутри группы,
    \item и на каждый такой вариант еще $6!$ вариантов расположения остальных шести цифр. Таким образом,
    \begin{equation}
        \modulus{C} = 7 \cdot 3! \cdot 6!
    \end{equation}
    Вероятность события $C$:
    \begin{equation}
        \probability{C}
        = \frac{\modulus{C}}{\modulus{\Omega}}
        = \frac{7 \cdot 3! \cdot 6!}{9!}
        = \frac{7 \cdot 3!}{9 \cdot 8 \cdot 7}
        = \frac{3!}{9 \cdot 8}
